# Сравнить хэш-таблицы с различными способами разрешения коллизий:  метод цепочек, метод двойного хэширования и один метод на выбор студента.
_______________

# Содержание

* [Метод цепочек](#cep)
* [Метод открытой адресации](#adr)
